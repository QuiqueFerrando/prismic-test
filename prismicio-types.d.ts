...
/**
 * Primary content in *CustomSlice → Default → Primary*
 */
export interface CustomSliceSliceDefaultPrimary {
  /**
   * Titulo field in *CustomSlice → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: custom_slice.default.primary.titulo
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  titulo: prismic.KeyTextField;

  /**
   * tiempo field in *CustomSlice → Default → Primary*
   *
   * - **Field Type**: Timestamp
   * - **Placeholder**: *None*
   * - **API ID Path**: custom_slice.default.primary.tiempo
   * - **Documentation**: https://prismic.io/docs/fields/timestamp
   */
  tiempo: prismic.TimestampField;
}

/**
 * Default variation for CustomSlice Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CustomSliceSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<CustomSliceSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *CustomSlice*
 */
type CustomSliceSliceVariation = CustomSliceSliceDefault;

/**
 * CustomSlice Shared Slice
 *
 * - **API ID**: `custom_slice`
 * - **Description**: CustomSlice
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CustomSliceSlice = prismic.SharedSlice<
  "custom_slice",
  CustomSliceSliceVariation
>;
...
/**
 * Item in *TabPanel → Default → Primary → Tabs*
 */
export interface TabPanelSliceDefaultPrimaryTabsItem {
  /**
   * Tab Label field in *TabPanel → Default → Primary → Tabs*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tab_panel.default.primary.tabs[].label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  label: prismic.KeyTextField;

  /**
   * Closable field in *TabPanel → Default → Primary → Tabs*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **API ID Path**: tab_panel.default.primary.tabs[].closable
   * - **Documentation**: https://prismic.io/docs/fields/boolean
   */
  closable: prismic.BooleanField;

  /**
   * Tab Content field in *TabPanel → Default → Primary → Tabs*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tab_panel.default.primary.tabs[].content
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
...
/**
 * Item in *TabPanel → TabbedContentWithoutClosing → Primary → Tabs*
 */
export interface TabPanelSliceTabbedContentWithoutClosingPrimaryTabsItem {
  /**
   * Tab Label field in *TabPanel → TabbedContentWithoutClosing → Primary → Tabs*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tab_panel.tabbedContentWithoutClosing.primary.tabs[].label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  label: prismic.KeyTextField;

  /**
   * Tab Content field in *TabPanel → TabbedContentWithoutClosing → Primary → Tabs*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tab_panel.tabbedContentWithoutClosing.primary.tabs[].content
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  content: prismic.RichTextField;
}
...
/**
 * Primary content in *TabPanel → Default → Primary*
 */
export interface TabPanelSliceDefaultPrimary {
  /**
   * Tabs field in *TabPanel → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tab_panel.default.primary.tabs[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  tabs: prismic.GroupField<Simplify<TabPanelSliceDefaultPrimaryTabsItem>>;
}

/**
 * Default variation for TabPanel Slice
 *
 * - **API ID**: `default`
 * - **Description**: Standard tab panel section with editable tabs, each having close functionality and associated content area.
 * - **Documentation**: https://prismic.io/docs/slices
 */
...
/**
 * Primary content in *TabPanel → TabbedContentWithoutClosing → Primary*
 */
export interface TabPanelSliceTabbedContentWithoutClosingPrimary {
  /**
   * Tabs field in *TabPanel → TabbedContentWithoutClosing → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tab_panel.tabbedContentWithoutClosing.primary.tabs[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  tabs: prismic.GroupField<
    Simplify<TabPanelSliceTabbedContentWithoutClosingPrimaryTabsItem>
  >;
}

/**
 * TabbedContentWithoutClosing variation for TabPanel Slice
 *
 * - **API ID**: `tabbedContentWithoutClosing`
 * - **Description**: Standard tab panel section with editable tabs, each having close functionality and associated content area.
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TabPanelSliceTabbedContentWithoutClosing =
  prismic.SharedSliceVariation<
    "tabbedContentWithoutClosing",
    Simplify<TabPanelSliceTabbedContentWithoutClosingPrimary>,
    never
  >;

/**
 * Slice variation for *TabPanel*
 */
type TabPanelSliceVariation =
  | TabPanelSliceDefault
  | TabPanelSliceTabbedContentWithoutClosing;

/**
 * TabPanel Shared Slice
 *
 * - **API ID**: `tab_panel`
 * - **Description**: *None*
 * - **Documentation**: https://prismic.io/docs/slices
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      CustomSliceSlice,
      CustomSliceSliceDefaultPrimary,
      CustomSliceSliceVariation,
      CustomSliceSliceDefault,
      HeroSlice,
      ...
      QuoteSliceDefault,
      TabPanelSlice,
      TabPanelSliceDefaultPrimaryTabsItem,
      TabPanelSliceDefaultPrimary,
      TabPanelSliceTabbedContentWithoutClosingPrimaryTabsItem,
      TabPanelSliceTabbedContentWithoutClosingPrimary,
      TabPanelSliceVariation,
      TabPanelSliceDefault,
      TabPanelSliceTabbedContentWithoutClosing,
      TextSlice,
